...
\end{figure}
	...
	We define `planets that are amenable to atmospheric characterization' to mean planets whose SNR in transmission is greater than (that of GJ 1214b divided by 2), where the latter factor of 2 is chosen to give a sufficiently large sample to prevent Poisson fluctuations from hindering our comparisons.
	...
	Reference parameters for GJ 1214b are those quoted
	...
	The \elong\:scenario dedicates 7 of a single year's 13 observing sectors to the ecliptic (where the other 5 are spent centered at the North Ecliptic Pole due to excessive Earth and Moon crossings).
