...
\begin{enumerate}
	...
	This figure shows what was originally noted by~\citetalias{Sullivan_2015}: \tesss original survey is incomplete: for stars dimmer than $I_c=9$, there are at least an order of magnitude more $R_p<4R_\oplus$ transiting planets that \tess does not detect (Fig 22 of~\citetalias{Sullivan_2015}).
