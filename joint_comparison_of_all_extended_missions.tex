...
\end{figure}
	...
	Put differently, among the various possibilities for the Extended Mission,
        there is more variation in $N_\mathrm{new,atm}$ than in $N_\mathrm{new,P<20d}$.
	...
	We note that even though \elong\:is the scenario most successful in to detecting planets about new stars, the new stars represent only $\sim\!30\%$ of the total number of new detections.~\footnote{Here, we remind the reader that ``new'' refers only to \tess\, observations. Some of these stars will
