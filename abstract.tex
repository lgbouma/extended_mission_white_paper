...
Any decisions on what to do with the \textit{TESS} spacecraft
after the Primary Mission should be made with the broadest
possible input and assistance from the astronomical community. There
are many other applications of precise time-series photometry of bright objects, beyond
exoplanet detection, as has recently been made clear by the NASA \textit{K2} mission.
...
Extended Mission, this white paper presents some simulations
...
aspects of any Extended Mission, recognizing that this will be only one part of
a much larger discussion of the scientific goals of such a mission.

We performed this work independently of the \tess Science Team.
In presenting it for community review, we hope provide a helpful
reference for any parties interested in \tesss Extended Mission.
We also created an accompanying 
document\footnote{\url{url_goes_here.com}.
 Please contact \url{luke@astro.princeton.edu} if you have further
 ideas to share. The webpage also includes catalogs of 
 detected planets for both the Primary and Extended Missions discussed in this 
 white paper.\label{fn:wiki}} to record broader discussion.

This report focuses narrowly on planet detection. 
