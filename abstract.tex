...
newly-detected planets for the 6 scenarios under consideration.
...
Sec.~\ref{sec:ephemeris_times} raises the critical issue of the uncertainty in 
transit ephemerides.
...
online\footnote{\url{scholar.princeton.edu/jwinn/extended-mission-simulations}\label{fn:wiki}}.
  This web site also
