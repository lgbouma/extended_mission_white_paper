...
`effective depth' $\delta/2$. A sign error\footnote{An $\texttt{=}$ rather than 
...
and those shown in the published version of~\citetalias{Sullivan_2015}, which 
originally claimed $\approx 1400$. The subsequent search led to the discovery 
of a bug in the script used to create~\citetalias{Sullivan_2015}'s Fig. 18, 
outside of the main simulation code. The corrected version 
