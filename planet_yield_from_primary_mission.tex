...
This is two orders of magnitude less than the $\sim1000$ super-Earth detections claimed from FFIs by~\citetalias{Sullivan_2015}.
...
Another plausibility argument for our yields vs. those of~\citetalias{Sullivan_2015} is that starting from the same input distribution of planets, we find a more reasonable detection bias against small planets.
\citetalias{Sullivan_2015} claims to detect roughly twice as many sub-Neptunes as super-Earths; we claim to detect five times as many sub-Neptunes as super-Earths.
...
%!WINN! make clearer, or else omit
%!BOUMA! made clearer above, but I was trying to actually gesture towards the power in the radius bias implied by S15's results vs. this works'. There may be a clearer way to do it than I did in the comment below.
\begin{comment}
This conclusion follows by considering the two relevant bins in the distribution of detected planet count \textit{vs}. planet radius. 
The $1.25R_\oplus<R_p<2R_\oplus$ bin has width $0.75R_\oplus$ and 1400 (400) planets fall within it according to~\citetalias{Sullivan_2015} (according to us).
The $2R_\oplus<R_p<4R_\oplus$ bin has width $2R_\oplus$ and 3000 (2000) planets fall within it according to~\citetalias{Sullivan_2015} (according to us).
The ratio of the number of detected super-Earths to sub-Neptunes (per bin width) for~\citetalias{Sullivan_2015}'s case is $(1400/0.75R_\oplus)/(3000/2R_\oplus)=1.25$, while for our case it is $(400/0.75R_\oplus)/(2000/2R_\oplus)=0.53$.
The input planet occurrence distributions (\citetalias{Sullivan_2015}'s Fig 8) imply that the intrinsic population ratio in this bin is $\sim\!2$ for $T_\mathrm{eff}<4000$K hosts and $\sim\!1.5$ for $T_\mathrm{eff}>4000$K hosts.
Thus the input ratio for the number of existing super-Earths (per bin width) to sub-Neptunes (per bin width) across all stars is between 1.5 and 2.

\citetalias{Sullivan_2015}'s result is that the detection bias for super-Earths ($R_p\approx1.5R_\oplus$) versus sub-Neptunes ($R_p\approx3R_\oplus$) is much weaker than that claimed in our work.
\end{comment}
...
In terms of the apparent planet radii $R_p$, orbital periods $P$, host star brightness, and host star $T_\mathrm{eff}$, we agree with the results of~\citetalias{Sullivan_2015} for the population of planets detected in postage stamps.
...
It was also seen by~\citetalias{Sullivan_2015}.
