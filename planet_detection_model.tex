...
\textit{i.e.,} proportional to the inverse square root of the time
in-transit).
...
The first equation is approximate. In particular we do not
take into account the
small contribution to the SNR from occultation signals.
